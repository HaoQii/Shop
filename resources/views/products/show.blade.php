...
</div> 这里使用了 Bootstrap 的按钮组来输出 SKU 列表。<ul class="nav nav-tabs" role="tablist"> ... </ul> 以及 <div class="tab-content"> ...
</div> 是 Bootstrap 的 Tab 插件，我们用来输出商品详情和评价列表，由于我们尚未涉及评价相关的逻辑因此这里暂时留空。{!! $product->description !!}
